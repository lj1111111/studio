L.TileLayer.WMTS = L.TileLayer.extend({
  ...
  getMatrix: function() {
    switch (this._crs.code) {
      ...
      case 'EPSG:3857':
        if (!this.options.origin || !this.options.origin.length || this.options.origin.length != 2) this.options.origin = [-20037508.342789, 20037508.342789];
        break;
    }
