	...
	<div style="height: calc(100% - 90px); ">
		...
		<div v-show="!isRight" class="right-component-item-content" style="height: calc(100% - 42px);display: flex;flex-direction: column;">
			...
			<el-row class="right-component-item" :gutter="4" type="flex" align='middle'>
				...
				<el-col :span="8">
					<el-input v-model:trim="params.data.fields.fieldX.target" placeholder="可自定义" size="small"></el-input>
				</el-col>
				<el-col :span="8">
					类目
				</el-col>
			...
			<el-row class="right-component-item" :gutter="4" type="flex" align='middle'>
				...
				<el-col :span="8">
					<el-input v-model:trim="params.data.fields.fieldY.target" placeholder="可自定义" size="small"></el-input>
				</el-col>
				<el-col :span="8">
					数值
				</el-col>
				...
				if(this.params.data.datasource.type == 1 || this.params.data.datasource.type == 2) {
					...
					if(data && this.isArray(data)) {
						...
						if(bNotVaild) {
							...
							//this.isState = true;
							this.params.option.series[0].data = [];
							for(var i = 0; i < count; i++) {
								if(data[i].hasOwnProperty(fieldX) && data[i].hasOwnProperty(fieldY)) {
									this.params.option.series[0].data.push({
										"name": data[i][fieldX],
										"value": data[i][fieldY]
									})
								}
